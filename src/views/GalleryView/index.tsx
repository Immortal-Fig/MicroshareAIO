  ...
  return (
    <div>
      <ul className="text-left font-semibold text-base mb-4">
        ...
        <li className=" mb-1"><span className='text-[#ff7f00] font-semibold'><strong>?</strong> No information</span> : not enough information about this NFT. Feel free to send to <a target="_blank" href="https://twitter.com/SolCheapo"><strong className="text-[#0080FF]">@SolCheapo</strong></a> the mint address in order to be add in one of the 2 others categories.</li>
      </ul>
